...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "points_ppr", sa.DECIMAL(10, 3), nullable=False, server_default="0.0"
        ),
        sa.Column(
            "points_halfppr", sa.DECIMAL(10, 3), nullable=False, server_default="0.0"
        ),
        sa.Column(
            "points_noppr", sa.DECIMAL(10, 3), nullable=False, server_default="0.0"
        ),
    )
