async def test_trade_endpoint(auth_client_trade):
    ...
    assert data["Alt Team"] == [
        {
            "players_1": [{"id": 1, "name": "Josh Allen"}],
            "gain_1": 5.5,
            "players_2": [{"id": 6, "name": "Tyler Warren"}],
            "gain_2": 5.299999999999997,
        },
        {
            "players_1": [{"id": 1, "name": "Josh Allen"}],
            "gain_1": 3.5,
            "players_2": [{"id": 15, "name": "NYG"}],
            "gain_2": 5.299999999999997,
        },
        {
            "players_1": [{"id": 9, "name": "Brandon Aubrey"}],
            "gain_1": 5.0,
            "players_2": [{"id": 6, "name": "Tyler Warren"}],
            "gain_2": 3.0,
        },
        ...
        },
        {
            "players_1": [
                ...
                {"id": 9, "name": "Brandon Aubrey"},
            ],
            "gain_1": 8.5,
            "players_2": [{"id": 6, "name": "Tyler Warren"}, {"id": 15, "name": "NYG"}],
            "gain_2": 8.299999999999997,
        },
    ]
...
async def test_trade_only_one_team_has_players(auth_client_players):
    await auth_client_players.post("/leagues/1/teams/1/players", json={"id": 1})
